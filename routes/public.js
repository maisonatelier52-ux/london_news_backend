...
// /**
//  * Public routes — no adminVerify middleware.
//  * These serve the user-facing Next.js frontend.
//  *
//  * Mount in server.js:
//  *   app.use('/api/public', require('./routes/public'));
//  */

// // ── Helper: format article for frontend ───────────────────────────────────────
...
//     // ImageKit URLs are already full absolute URLs — return as-is
//     image: article.image || '',
//     imageAlt: article.imageAlt || article.title,
//     date: article.date
//       ? article.date.toLocaleDateString('en-GB') // "DD/MM/YYYY"
//       : '',
...
//       .populate('author', 'name bio country profileImage social')
//       .sort({ date: -1 });
...
//       (s) => s._id.toString() === article._id.toString()
//     );
...
// GET /api/public/author/:slug  — full author profile + their articles
router.get('/author/:slug', async (req, res) => {
  try {
    ...
    // Fetch latest articles by this author
